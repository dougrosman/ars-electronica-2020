$(document).ready(function(){
    ...
    function animateTitle(_speed) {
        ...
        $(".header-titles").delay(_speed * 250).animate({
            ...
            $(".fa-angle-down").delay(_speed * 0).animate({
                opacity: 1
            }, _speed * 500);
    ...
    function scrollToContent(_speed){
        $(".main-content").css('display', 'flex').css('opacity', '1');
            let offsets = calculateOffsets();
            
        $('html, body').scrollTop(offsets[0] + -60);
    }

    // function scrollToContent(_speed){
    //     $(".fa-angle-down").delay(_speed * 50).css('cursor', 'default').animate({
    //         opacity: 0
    //     }, _speed * 500, function(){
    ...
    //         }, _speed * 500);
    //         let offsets = calculateOffsets();
    //         $('html, body').delay(200).animate({scrollTop: offsets[0]}, 1000);
    //     });
    // }

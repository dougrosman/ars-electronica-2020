...
$(document).ready(function(){
    ...
    // <h3 class="curated-by">Curated by:</h3>
    // <p class="curators">Duncan Bass, Bopha Hul, Patrick O’Shea and Doug Rosman</p>
    // <h3 class="curated-by">Web development:</h3>
    // <p class="curators">Doug Rosman</p>`

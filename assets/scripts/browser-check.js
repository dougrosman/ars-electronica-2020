...
$(document).ready(function(){
  ...
  function displayBrowserWarning(){
    ...
    {
      $(".desktop-ff-ch").show().delay(speed * 2000).animate({
        opacity: 1
      }, 1000);
    ...
    // mobile and Firefox only
    // if(jQuery.browser.mobile || browser=="Firefox") {
    //   $('.firefox-mobile-only').show();
    // } else {
    //   $('.jason-site').show();
    // }
    ...
    if(jQuery.browser.mobile) {
      ...
      $(".desktop-only").show().delay(speed * 1500).animate({
        opacity: 1
      }, 1000);
    }
  ...
  // Kristin: Firefox and Chrome only
